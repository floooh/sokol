...
[**See what's new**](https://github.com/floooh/sokol/blob/master/CHANGELOG.md) (**09-Aug-2026**: sokol_gfx.h: new flexible functions for populating immutable buffers and images)
