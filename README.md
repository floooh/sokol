...
[**See what's new**](https://github.com/floooh/sokol/blob/master/CHANGELOG.md) (**22-Sep-2025**: fix a compute-pass bindings dependency problem in the sokol_gfx.h d3d11 backend introduced in the resource-view-update)
