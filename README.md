...
[**See what's new**](https://github.com/floooh/sokol/blob/master/CHANGELOG.md) (**22-Sep-2025**: fix a compute-pass bindings dependency problem introduced in the resource-view-update)
