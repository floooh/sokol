...
/*
    ...
    sokol-shdc -i sspine.glsl -o sspine.h -l glsl410:glsl300es:hlsl4:metal_macos:metal_ios:metal_sim:wgsl:spirv_vk -b
...
*/
static const uint8_t _sspine_vs_bytecode_spirv_vk[1404] = {
...
/*
    ...
    void main()
    {
        vec4 _28 = texture(sampler2D(tex, smp), uv) * color;
        float _37 = _28.w;
        frag_color = mix(_28, vec4(_28.xyz * _37, _37) * color, vec4(_53.pma));
    }
*/
static const uint8_t _sspine_fs_bytecode_spirv_vk[1520] = {
