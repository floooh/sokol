...
*/
static const uint8_t _sfons_vs_bytecode_spirv_vk[1668] = {
...
/*
    ...
    void main()
    {
        frag_color = vec4(1.0, 1.0, 1.0, texture(sampler2D(tex, smp), uv.xy).x) * color;
    }

*/
static const uint8_t _sfons_fs_bytecode_spirv_vk[888] = {
