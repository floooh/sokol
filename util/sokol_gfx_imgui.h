...
_SOKOL_PRIVATE const char* _sgimgui_pixelformat_string(sg_pixel_format fmt) {
    switch (fmt) {
        ...
        case SG_PIXELFORMAT_DEPTH24PLUS: return "SG_PIXELFORMAT_DEPTH24PLUS";
        case SG_PIXELFORMAT_DEPTH24PLUS_STENCIL8: return "SG_PIXELFORMAT_DEPTH24PLUS_STENCIL8";
        case SG_PIXELFORMAT_DEPTH32F: return "SG_PIXELFORMAT_DEPTH32F";
        case SG_PIXELFORMAT_DEPTH32F_STENCIL8: return "SG_PIXELFORMAT_DEPTH32F_STENCIL8";
