...
static const uint8_t _sdtx_shd_vs_source_glsl410[342] = {
...
static const uint8_t _sdtx_shd_fs_source_glsl410[224] = {
...
static const uint8_t _sdtx_shd_vs_source_glsl300es[303] = {
...
static const uint8_t _sdtx_shd_fs_source_glsl300es[255] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
...
static const uint8_t _sdtx_shd_vs_bytecode_metal_macos[2842] = {
...
static const uint8_t _sdtx_shd_fs_bytecode_metal_macos[3063] = {
    0x4d,0x54,0x4c,0x42,0x01,0x80,0x02,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
static const uint8_t _sdtx_shd_vs_bytecode_metal_ios[2970] = {
...
static const uint8_t _sdtx_shd_fs_bytecode_metal_ios[3239] = {
    0x4d,0x54,0x4c,0x42,0x01,0x00,0x02,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
static const uint8_t _sdtx_shd_vs_source_metal_sim[576] = {
...
static const uint8_t _sdtx_shd_fs_source_metal_sim[441] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
static const uint8_t _sdtx_shd_vs_bytecode_hlsl4[692] = {
...
static const uint8_t _sdtx_shd_fs_bytecode_hlsl4[608] = {
...
static const uint8_t _sdtx_shd_vs_source_wgsl[832] = {
...
static const uint8_t _sdtx_shd_fs_source_wgsl[590] = {
    0x64,0x69,0x61,0x67,0x6e,0x6f,0x73,0x74,0x69,0x63,0x28,0x6f,0x66,0x66,0x2c,0x20,
    0x64,0x65,0x72,0x69,0x76,0x61,0x74,0x69,0x76,0x65,0x5f,0x75,0x6e,0x69,0x66,0x6f,
    0x72,0x6d,0x69,0x74,0x79,0x29,0x3b,0x0a,0x0a,0x76,0x61,0x72,0x3c,0x70,0x72,0x69,
...
static const uint8_t _sdtx_shd_vs_bytecode_spirv_vk[1248] = {
...
static const uint8_t _sdtx_shd_fs_bytecode_spirv_vk[816] = {
...
static void _sdtx_setup_common(void) {
    ...
    #if defined(SOKOL_GLCORE)
        shd_desc.vertex_func.source = (const char*)_sdtx_shd_vs_source_glsl410;
        shd_desc.fragment_func.source = (const char*)_sdtx_shd_fs_source_glsl410;
    #elif defined(SOKOL_GLES3)
        shd_desc.vertex_func.source = (const char*)_sdtx_shd_vs_source_glsl300es;
        shd_desc.fragment_func.source = (const char*)_sdtx_shd_fs_source_glsl300es;
    #elif defined(SOKOL_METAL)
        shd_desc.vertex_func.entry = "main0";
        shd_desc.fragment_func.entry = "main0";
        switch (sg_query_backend()) {
            case SG_BACKEND_METAL_MACOS:
                shd_desc.vertex_func.bytecode = SG_RANGE(_sdtx_shd_vs_bytecode_metal_macos);
                shd_desc.fragment_func.bytecode = SG_RANGE(_sdtx_shd_fs_bytecode_metal_macos);
                break;
            case SG_BACKEND_METAL_IOS:
                shd_desc.vertex_func.bytecode = SG_RANGE(_sdtx_shd_vs_bytecode_metal_ios);
                shd_desc.fragment_func.bytecode = SG_RANGE(_sdtx_shd_fs_bytecode_metal_ios);
                break;
            default:
                shd_desc.vertex_func.source = (const char*)_sdtx_shd_vs_source_metal_sim;
                shd_desc.fragment_func.source = (const char*)_sdtx_shd_fs_source_metal_sim;
                break;
        }
    #elif defined(SOKOL_D3D11)
        shd_desc.vertex_func.bytecode = SG_RANGE(_sdtx_shd_vs_bytecode_hlsl4);
        shd_desc.fragment_func.bytecode = SG_RANGE(_sdtx_shd_fs_bytecode_hlsl4);
    #elif defined(SOKOL_WGPU)
        shd_desc.vertex_func.source = (const char*)_sdtx_shd_vs_source_wgsl;
        shd_desc.fragment_func.source = (const char*)_sdtx_shd_fs_source_wgsl;
    #elif defined(SOKOL_VULKAN)
        shd_desc.vertex_func.bytecode = SG_RANGE(_sdtx_shd_vs_bytecode_spirv_vk);
