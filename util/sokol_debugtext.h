...
static void _sdtx_setup_common(void) {
    ...
    shd_desc.fs.image_sampler_pairs[0].glsl_name = "tex_smp";
    #if defined(SOKOL_GLCORE)
        shd_desc.vs.source = (const char*)_sdtx_vs_source_glsl410;
        shd_desc.fs.source = (const char*)_sdtx_fs_source_glsl410;
    #elif defined(SOKOL_GLES3)
        shd_desc.vs.source = (const char*)_sdtx_vs_source_glsl300es;
        shd_desc.fs.source = (const char*)_sdtx_fs_source_glsl300es;
    #elif defined(SOKOL_METAL)
        ...
        switch (sg_query_backend()) {
            ...
            case SG_BACKEND_METAL_IOS:
                ...
                break;
            default:
                shd_desc.vs.source = (const char*)_sdtx_vs_source_metal_sim;
                shd_desc.fs.source = (const char*)_sdtx_fs_source_metal_sim;
                break;
        }
    #elif defined(SOKOL_D3D11)
    ...
    #elif defined(SOKOL_WGPU)
        shd_desc.vs.source = (const char*)_sdtx_vs_source_wgsl;
        shd_desc.fs.source = (const char*)_sdtx_fs_source_wgsl;
    #else
