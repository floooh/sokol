...
/*
    ...
    sokol-shdc -i debugtext.glsl -o debugtext.h -l glsl410:glsl300es:hlsl4:metal_macos:metal_ios:metal_sim:wgsl:spirv_vk -b
...
*/
static const uint8_t _sdtx_vs_bytecode_spirv_vk[1248] = {
...
*/
static const uint8_t _sdtx_fs_bytecode_spirv_vk[816] = {
...
static void _sdtx_setup_common(void) {
    ...
    #elif defined(SOKOL_VULKAN)
        shd_desc.vertex_func.bytecode = SG_RANGE(_sdtx_vs_bytecode_spirv_vk);
        shd_desc.vertex_func.entry = "main";
        shd_desc.fragment_func.bytecode = SG_RANGE(_sdtx_fs_bytecode_spirv_vk);
