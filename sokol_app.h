...
// check if the config defines are alright
    ...
    #if !defined(SOKOL_D3D11) && !defined(SOKOL_D3D12) && !defined(SOKOL_GLCORE) && !defined(SOKOL_WGPU) && !defined(SOKOL_NOAPI)
    #error("sokol_app.h: unknown 3D API selected for Win32, must be SOKOL_D3D11, SOKOL_D3D12, SOKOL_GLCORE, SOKOL_WGPU or SOKOL_NOAPI")
    #endif
