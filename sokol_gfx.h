...
enum {
    ...
    SG_MAX_SHADERSTAGE_BUFFERS = SOKOL_GFX_MAX_SHADERSTAGE_BUFFERS,
#else
    SG_MAX_SHADERSTAGE_BUFFERS = 8,
#endif

#ifdef SOKOL_GFX_MAX_SHADERSTAGE_IMAGES
    SG_MAX_SHADERSTAGE_IMAGES = SOKOL_GFX_MAX_SHADERSTAGE_IMAGES,
#else
    SG_MAX_SHADERSTAGE_IMAGES = 12,
#endif

#ifdef SOKOL_GFX_MAX_SHADERSTAGE_UBS
    SG_MAX_SHADERSTAGE_UBS = SOKOL_GFX_MAX_SHADERSTAGE_UBS,
#else
    SG_MAX_SHADERSTAGE_UBS = 4,
#endif

#ifdef SOKOL_GFX_MAX_UB_MEMBERS
    SG_MAX_UB_MEMBERS = SOKOL_GFX_MAX_UB_MEMBERS,
#else
    SG_MAX_UB_MEMBERS = 16,
#endif

#ifdef SOKOL_GFX_MAX_VERTEX_ATTRIBUTES
    SG_MAX_VERTEX_ATTRIBUTES = SOKOL_GFX_MAX_VERTEX_ATTRIBUTES,
#else
