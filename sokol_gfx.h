...
typedef struct {
    ...
    sg_image cur_vs_image_ids[_SG_MTL_MAX_STAGE_TEXTURE_BINDINGS];
    sg_image cur_fs_image_ids[_SG_MTL_MAX_STAGE_TEXTURE_BINDINGS];
    sg_image cur_cs_image_ids[_SG_MTL_MAX_STAGE_TEXTURE_BINDINGS];
