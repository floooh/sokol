...
/*
    ...
    ...otherwise here's how to provide the information needed for creating shaders
    without the help of sokol-shdc.

    To get a general idea how this works, please have a look at the backend-specific
    sokol samples, those all create shader object directly without sokol-shdc:
